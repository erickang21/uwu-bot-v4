...
class Eightball extends Command {
  ...
  async run(ctx, options) {
    ...
    const embed = this.client.embed()
      ...
      .setColor(0x9590EE)
      .setFooter({ text: "The Mighty 8-Ball", iconURL: "https://vignette.wikia.nocookie.net/battlefordreamislandfanfiction/images/5/53/8-ball_my_friend.png/revision/latest?cb=20161109021012" });
